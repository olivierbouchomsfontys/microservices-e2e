using CustomerOrderService.Messaging.Listener;
...
namespace CustomerOrderService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "CustomerOrderService", Version = "v1"});
            });
            ...
            services.AddHostedService<CustomerCreatedListener>();
